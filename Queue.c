...
#ifdef ALLOC_PRAGMA
#pragma alloc_text (PAGE, DevOSASPhilippovich191351QueueInitialize)
#endif

NTSTATUS
DevOSASPhilippovich191351QueueInitialize(
...
--*/
{
    ...
    queueConfig.EvtIoDeviceControl = DevOSASPhilippovich191351EvtIoDeviceControl;
    queueConfig.EvtIoStop = DevOSASPhilippovich191351EvtIoStop;
...
VOID
DevOSASPhilippovich191351EvtIoDeviceControl(
    _In_ WDFQUEUE Queue,
...
VOID
DevOSASPhilippovich191351EvtIoStop(
    _In_ WDFQUEUE Queue,
    _In_ WDFREQUEST Request,
